      ...
      <main className="flex-1 py-12">
        <div className="container mx-auto grid items-center gap-6 px-4 md:px-6 grid-cols-1 lg:grid-cols-2 lg:gap-10">
          <div className="space-y-3">
            ...
            <h1 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">JWT認証</h1>
            <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              このページでは、JWT（JSON Web Token）を使用した認証を体験できます。ログイン後、
              サーバーからJWTが発行され、クライアント側に保存されます。
            </p>
            <div className="space-y-4 rounded-lg border bg-gray-50 p-4">
              <h3 className="font-semibold">JWT認証の特徴:</h3>
          ...
          <div className="mx-auto w-full max-w-sm space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>JWT認証でログイン</CardTitle>
            ...
            <div className="text-center text-sm">
              <Link href="/login-traditional" className="underline">
                従来のセッション認証を試してみる
              </Link>
            </div>
          </div>
